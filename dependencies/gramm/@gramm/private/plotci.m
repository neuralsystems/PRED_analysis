function hndl=plotci(obj,x,y,yci,draw_data,geom,dodge,width)
            ...
            for k=1:length(geom)
                switch geom{k}
                    ...
                    case 'area_only'
                        hndl.area_handle=patch('Vertices',vertices,'Faces',faces,'FaceColor',draw_data.color,'FaceAlpha',0.4,'EdgeColor','none');
                   ...
                   case 'edge_bar'
                    ...
                    case 'point'
                        hndl.point_handle=plot(x,y,draw_data.marker,'MarkerEdgeColor',draw_data.color,'markerSize',draw_data.point_size,'MarkerFaceColor',[1 1 1], 'LineWidth',draw_data.line_size);
                    case 'mean_line'
